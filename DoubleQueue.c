...
/* in this case we will consider prioritary people above 50 years */
...
int main()
{
    ...
    insert_queue(fila, 52, "João");
    insert_queue(fila, 71, "Gerusa");
    insert_queue(fila, 23, "Abel");
    print_queue(fila); //imprime a fila
    printf("idade primeira pessoa: %d\n",fila->head->age); //imprime a idade da primeira pessoa da fila
    printf("idade última pessoa: %d\n",fila->tail->age); //imprime  a idade da última pessoa da fila
}